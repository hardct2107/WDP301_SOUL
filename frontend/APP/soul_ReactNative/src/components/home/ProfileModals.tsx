      ...
      >
        <SafeAreaView style={styles.modalContainer}>
          <View style={styles.modalHeader}>
            ...
            >
              <MaterialCommunityIcons name="pencil-outline" size={24} color="#9B67CC" />
            </TouchableOpacity>
          </View>
          ...
          <ScrollView contentContainerStyle={styles.modalScroll}>
            ...
            <View style={styles.detailsCard}>
              ...
              <View style={styles.detailRow}>
                <MaterialCommunityIcons name="email-outline" size={22} color="#9B67CC" style={styles.detailIcon} />
              ...
              {/* Họ và Tên */}
              <View style={styles.detailRow}>
                <MaterialCommunityIcons name="account-outline" size={22} color="#9B67CC" style={styles.detailIcon} />
                <View style={styles.detailTextGroup}>
              ...
              {/* Số điện thoại */}
              <View style={styles.detailRow}>
                <MaterialCommunityIcons name="phone-outline" size={22} color="#9B67CC" style={styles.detailIcon} />
                <View style={styles.detailTextGroup}>
              ...
              {/* Giới tính */}
              <View style={styles.detailRow}>
                <MaterialCommunityIcons name="gender-male-female" size={22} color="#9B67CC" style={styles.detailIcon} />
                <View style={styles.detailTextGroup}>
              ...
              {/* Ngày sinh */}
              <View style={styles.detailRow}>
                <MaterialCommunityIcons name="calendar-outline" size={22} color="#9B67CC" style={styles.detailIcon} />
                <View style={styles.detailTextGroup}>
        ...
        <SafeAreaView style={styles.modalContainer}>
          <View style={styles.modalHeader}>
            ...
            <TouchableOpacity onPress={handleSaveProfile} disabled={saving}>
              {saving ? (
                <ActivityIndicator color="#9B67CC" size="small" />
              ) : (
              ...
              <View style={styles.avatarContainer}>
                <View style={styles.avatarLargeWrapper}>
                  ...
                  <View style={styles.cameraBadge}>
                    <MaterialCommunityIcons name="camera-outline" size={18} color="#9B67CC" />
                  </View>
                </View>
