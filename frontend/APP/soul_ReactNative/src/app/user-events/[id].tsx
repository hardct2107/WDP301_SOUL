  ...
  return (
    <SafeAreaView style={screenStyles.safeArea}>
      <View style={screenStyles.header}>
        ...
        >
          <MaterialCommunityIcons name="bookmark-check-outline" size={23} color="#9B67CC" />
        </TouchableOpacity>
      </View>
  ...
  return (
    <View style={screenStyles.infoRow}>
      <View style={screenStyles.infoIcon}>
        <MaterialCommunityIcons name={icon} size={18} color="#9B67CC" />
      </View>
...
function StatCard({
  ...
  return (
    <View style={screenStyles.statCard}>
      <MaterialCommunityIcons name={icon} size={20} color="#9B67CC" />
