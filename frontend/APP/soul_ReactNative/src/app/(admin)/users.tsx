            ...
            <View style={styles.popupCard}>
              ...
              {selectedUserForModal.role === "event_organizer" ? (
                ...
                selectedUserForModal.role !== "admin" && (
                  ...
                  >
                    <MaterialCommunityIcons name="calendar-plus" size={20} color="#9B67CC" />
                    <Text style={[styles.popupActionBtnText, { color: "#9B67CC" }]}>
            ...
            <View style={styles.popupCard}>
              ...
              >
                <MaterialCommunityIcons
                  ...
                  size={36}
                  color={confirmConfig.isDestructive ? "#DC2626" : "#9B67CC"}
                />
              </View>
              ...
              <View style={styles.confirmButtons}>
                ...
                <TouchableOpacity
                  style={[
                    ...
                    { backgroundColor: confirmConfig.isDestructive ? "#DC2626" : "#9B67CC" },
                  ]}
